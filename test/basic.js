  ...
  return Promise.all([
    it('exists', function() {
      ...
      function() {
        ...
        return it('watchDir modify', function() {
          var tmp;
        ...
        return it('watchDir create', function() {
          var tmp;
        ...
        return it('watchDir delete', function() {
          var tmp;
